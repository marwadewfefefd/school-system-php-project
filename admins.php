            ...
            <div class="row">
                  ...
                  <table class="table mb-5" style="background-color:#fff;">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="editadmin.php?id=<?php echo $row['id'] ;?>&name=<?php echo $row['username'];?>&pass=<?php echo $row['password'];?>" class="btn btn-custom">تعديل </a></td>
                                        <td><a href="deladmin.php?id=<?php echo $row['id']; ?>" class="btn btn-custom" name="delete">حذف </a></td>
                     ...
                     <div class="col-md-1">
                      <a href="newadmin.php"class="btn btn-info sidebtn " >إضافة مستخدم</a>
                  </div>
            </div>
            </div>
            <!------------------------>
