...
<body>
            ...
            <div class="col-md-10" id="main-area">
                ...
                <div class="w-100 p-3" style="text-align:center;background-color:#dfe6e9;"><h3>إضافة مستخدم جديد   </h3></div>
                    ...
                    if(isset($_POST['add'])){
                        ...
                        if(empty($name)||empty($pass)){
                            echo"<div class='alert alert-danger text-center'>الرجاء ملء الحقل ادناه </div>";
                                ...
                                if($result){echo "<div class='alert alert-success text-center'>تم اضافة  بنجاح  </div>";}
                    ...
                    <div class="form-group row">
                        ...
                        <button class=" btn btn-custom form-control"  name="add">إضافة مستخدم </button>
