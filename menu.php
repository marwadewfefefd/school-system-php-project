...
<body>
            ...
            <div class="col-md-10" id="main-area">
                  ...
                  <table class="table mb-5" style="background-color:#fff;">
                                    ...
                                    <tr>
                                        <td><?php echo $no ;?></td>
                                        <td><?php echo $row['menuHead'];?></td>
                                        <td><?php echo $row['menuDetail'];?></td>
                                        <td><a href="editmenu.php?id=<?php echo $row['menuId'] ;?>&name=<?php echo $row['menuHead'];?>&detail=<?php echo $row['menuDetail'] ;?>" class="btn btn-custom">تعديل </a></td>
                                        <td><a href="delmenu.php?id=<?php echo $row['menuId']; ?>" class="btn btn-custom" name="delete">حذف </a></td>
                  ...
                  <div class="col-md-1">
                      <a href="newmenu.php"class="btn btn-info sidebtn " >إضافة عنوان</a>
                  </div>
                  </div>
