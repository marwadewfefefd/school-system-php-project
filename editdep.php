...
<body>
            ...
            <div class="col-md-10" id="main-area">
                <div class="add-category">
                    ...
                    if(isset($_POST['add'])){
                        ...
                        if(empty($title)||empty($content)){
                            ...
                            if(isset($_FILES['postImage'])){
                                ...
                                $sql="UPDATE `department` SET `depname`='$title',`depdetail`='$content',`depimage`='$ext' WHERE depid='$id'";
                                ...
                                $sq="UPDATE `department` SET `depname`='$title',`depdetail`='$content',`depimage`='$oldimage' WHERE depid='$id'";
                    ...
                    ?>
                    <div class="titbtn"><button class="btn btn-custom2">تعديل بيانات القسم</button></div>
