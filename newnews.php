                    ...
                    if(isset($_POST['add'])){
                        ...
                        if(empty($title)||empty($content)){
                            ...
                            if(isset($_FILES['postImage'])){
                                ...
                                $sql="INSERT INTO `news`(`newsTitle`, `newsDetail`, `newsImage`) VALUES ('$title','$content','$ext')";
                                $result=mysqli_query($conn,$sql);
                                if($result){echo "<div class='alert alert-success text-center'>تم اضافة الخبر  بنجاح  </div>";}
                                else{echo"<div class='alert alert-danger text-center'>حدث خطأ  </div>";}
                            }
                        }
                    }
                    ?>
                    <div class="titbtn"><button class="btn btn-custom2">اضف خبر جديد</button></div>
